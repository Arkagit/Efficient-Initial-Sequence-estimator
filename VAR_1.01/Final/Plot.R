...
add_legend("topleft", legend = subsize,
       lwd = 1, cex = 0.6, col = "black", pch = 1:(dim(time)[1]))
dev.off()
...
legend("topright", bty = "n",legend = c("BM", "New ISE (Geyer)", "ISE", "SVE", "New ISE (MLS)", "True"), 
  col = c("black", "purple", "green", "skyblue", "brown", "black"), lty = c(1,1,1,1,1,2), cex=0.55)
...
legend("bottomright", bty = "n",legend = c("BM", "New ISE (Geyer)", "ISE", "SVE", "New ISE (MLS)", "True"), 
  col = c("black", "purple", "green", "skyblue", "brown", "black"), lty = c(1,1,1,1,1,2), cex=0.55)
...
legend("topright", bty = "n",legend = c("BM", "New ISE (Geyer)", "ISE", "SVE", "New ISE (MLS)"), 
  col = c("black", "purple", "green", "skyblue", "brown"), lty = 1, cex=0.65)
...
legend("topleft", bty = "n",legend = c("BM", "New ISE (Geyer)", "ISE", "SVE", "New ISE (MLS)"), 
  col = c("black", "purple", "green", "skyblue", "brown"), lty = 1, cex=0.65)
