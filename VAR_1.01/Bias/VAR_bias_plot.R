...
pdf("plot_bias_1.01.pdf", height = 6, width = 6)
par(mfrow = c(1,1))
plot(sizes, b_bm, type = "b", col = "black", ylab = "Average bias of determinants", xlab = "Log Chain length",
 ylim = c(-0.45, 0.2))
...
abline(h = 0, lty = 2)
add_legend("topright", bty = "n",legend = c("BM", "SVE", "New ISE (Geyer)", "New ISE (MLS)", "ISE"),
