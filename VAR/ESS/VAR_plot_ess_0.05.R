...
pdf("plot_ess_0.05.pdf", height = 6, width = 6)
par(mar = c(5.1, 4.8, 4.1, 2.1))
plot(subsize, colMeans(ess_track$BM), ylim = c(0.87, 0.95),
...
pdf("plot_frob_0.05.pdf", height = 6, width = 6)
par(mar = c(5.1, 4.8, 4.1, 2.1))
plot(subsize, colMeans(ess_track$Frob_bm),type = 'l', xlab = "Time", ylim = c(7.8, 9.0),
